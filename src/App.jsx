  ...
  return (
    <div className="min-h-svh bg-gray-50 flex justify-center">
      ...
      <div className="w-full max-w-[430px] min-h-svh bg-gray-50 relative flex flex-col" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
        ...
        {/* Bottom Navigation */}
        {isMain && (
          <nav className="fixed left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-white border-t border-gray-100 flex z-30" style={{ bottom: 'calc(0px - env(safe-area-inset-bottom) + 10px)' }}>
            {NAV.map((n) => (
              <button
                key={n.id}
